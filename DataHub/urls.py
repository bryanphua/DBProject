...
urlpatterns = [
    ...
    url(r'^comment/rate/(?P<comment>[0-9]{1,11})/(?P<rate>(-)?1)/(?P<origin>.*)$', views.rate_comment, name = 'rate_dataset'),
    url(r'^statistics/datasets/$', views.popular_datasets, name = 'popular_datasets'),
    url(r'^statistics/users/$', views.popular_users, name = 'popular_users'),
    url(r'^statistics/genres/$', views.popular_genres, name = 'popular_genres'),
